...
Equivalent du cerveau. 

Il récupère les différentes instructions d'un programme et va traiter et calculer les résultats pour les donner en sortie. Il prend chaque instruction dans son ordre d'arrivée.
...
- nombre de cœurs par processeur : un cœur est une unité de traitement. Pour un ordinateur de bureau classique, on recommande entre 2 et 4 cœurs. 
- génération
- coût / performance
- hyperthreading : CPU qui charge un cœur avec deux tâches en simultané. Un CPU à 2 cœurs passe donc pour un CPU à 4 cœurs. Ils sont souvent moins chers, mais la performance n'est pas la même.
- fonctionnalités du processeur : par exemple l'édition d'image, l'IA, la cryptographie, la [[Virtualisation]].
- [[Carte graphique]] intégrés à la [[Carte mère]] : si un [[Carte graphique]] intégré suffit, il faut vérifier que la [[Carte mère]] le propose. 